...
struct Cell
{
    ...
    */
    ...
    inline int side_val (Side l_or_r) { return get_side(l_or_r); }

    /** returns the value of Direction dir in cell l_or_r */
    inline bool check_direction(Side l_or_r, Direction dir) { return (walls >> (int(l_or_r) + int(dir))) & 0b1; }
    ...
    inline bool get_side(Side l_or_r) { return (walls >> int(l_or_r)) & 0b1111; }
    ...
    */
    ...
    inline void setDirection (Side l_or_r, Direction dir) { walls |= (0b1 << (int(l_or_r) + int(dir))); }

    //Flips the state of the bit corresponding to dir
    inline void updateDirection (Side l_or_r, Direction dir) { walls ^= (0b1 << (int(l_or_r) + int(dir))); }
